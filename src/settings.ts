...
export const SETTINGS = {
  ...
  "agent.commission_basis_points": define({
    ...
    description: "On every transfer an agent brings in, this share of our part of the fee is paid into the agent's wallet, in basis points. 2000 is 20 percent.",
    fallback: 2_000,
  ...
  "agent.discount_basis_points": define({
    ...
    description: "How much below face value an agent pays when buying airtime or bundles for customers from their wallet, in basis points. 200 is 2 percent.",
    fallback: 200,
